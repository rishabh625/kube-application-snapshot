...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name kube-application-snapshot-builder
	$(CONTAINER_TOOL) buildx use kube-application-snapshot-builder
	- $(CONTAINER_TOOL) buildx build --push --platform=$(PLATFORMS) --tag ${IMG} -f Dockerfile.cross .
	- $(CONTAINER_TOOL) buildx rm kube-application-snapshot-builder
	rm Dockerfile.cross
